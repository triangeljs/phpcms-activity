...
?>
<div class="pad-10">
<form method="post" action="?m=activity&c=activity&a=add" name="myform" id="myform">
<table class="table_form" width="100%" cellspacing="0">
	<tr>
		<th width="150"><strong>活动名称：</strong></th>
		<td><input name="info[title]" id="title" class="input-text" type="text" size="30" ></td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td><?php echo form::select($template_list, $info['default_style'], 'name="info[default_style]" id="style" onchange="load_file_list(this.value)"', L('please_select'))?></td>
	</tr>
	<tr>
	  <th width="150"><strong>模板选择：</strong></th>
	  <td id="show_template"><script type="text/javascript">$.getJSON('?m=admin&c=category&a=public_tpl_file_list&style=<?php echo $info['default_style']?>&module=activity&templates=show&name=info&pc_hash='+pc_hash, function(data){$('#show_template').html(data.show_template);});</script></td>
	</tr>
</table>
